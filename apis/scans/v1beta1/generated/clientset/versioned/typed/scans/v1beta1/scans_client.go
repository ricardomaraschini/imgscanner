...
import (
	...
	"github.com/ricardomaraschini/imgscanner/apis/scans/v1beta1/generated/clientset/versioned/scheme"
...
func (c *ShipwrightV1beta1Client) ImageScans() ImageScanInterface {
	return newImageScans(c)
}
